...
@endif
  ...
  <div class="form-group" style="margin-top: 0px;">
    <button type="submit" class="btn btn-back " style="margin-top: 0px;float: right;">Back</button>
  </div>
</div>



            <div class="hostel-header with-border  border-hostel">
...
{!! Form::open(['url' => 'admin/hostel/save','method' => 'post','files'=>true]) !!}
    ...
    {!!     Form::text('googleurl', null,  ['class' => 'form-control', 'placeholder' => 'Google Url']) !!}
          ...
          <div class="box-body">
            ...
            <div class="hostel-header with-border address-border">
 ...
 -->
          <div class="form_error"></div>
             ...
             <div class="box-body">
               <div class="col-xs-6">
                 ...
                 <select class="form-control" name="h_city" id="cities"></select>
          ...
          <div class="form_error"></div>
              ...
              <div class="hostel-header with-border  Features-border">
...
<!-- <select name="users_list" id="users_list" multiple="multiple" size="15">
   ...
   {!!Form::label('facility', 'Select Hostel Facility ') !!}
    ...
    <select name="facility[]"  multiple="multiple" style="height: 100px;width:100%;float:left;margin-left: 10px;">
 ...
 -->
  ...
  <div class="form_error"></div>
         ...
         <div class="hostel-header with-border  warden-border">
          ...
          <div class="box-footer">
              <div class="col-xs-4">
                <!--<button type="clear" class="btn btn-default">Cancel</button>-->
                  <button type="submit" class="btn btn-back " style="margin-bottom:65px;float: left;margin-right:4px;">Back</button>
