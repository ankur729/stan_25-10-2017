...
@endif
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Complaint Sub Category   </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
{!! Form::model($subcategory,['url' => 'admin/complaint_subcategory/update','method' => 'put']) !!}
  ...
  {!! Form::hidden('id', $subcategory->id) !!}
    ...
    {!!     Form::select('category_id', $myarr, null,  ['class' => 'form-control']) !!}
    ...
    {!!     Form::text('name', null,  ['class' => 'form-control', 'placeholder' => 'Sub Category Name']) !!}
          ...
          <div class="box-footer">
              <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-success pull-right" style="margin-bottom:65px;">Edit Category</button>
              </div>
              </div>
